...
namespace ExtensionMethods
{
    class Program
    {
        ...
        {
            var memberList = new LinkedList<ClubMember>();
            ...
            int sum = 0;
            memberList.ForEach(clubMember => sum += clubMember.Age);
            Console.WriteLine(sum);
            
            memberList.ForEach(clubMember => { if (clubMember.Gender == Gender.Male) Console.WriteLine(clubMember.FirstName); });
            memberList.ForEach(clubMember => Console.WriteLine(clubMember.FirstName + " " + clubMember.LastName)); 
