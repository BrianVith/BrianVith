...
namespace BonusApp
{
    public class Order
    {
        ...
        public double GetBonus(BonusProvider test)
        {
            return test(GetValueOfProducts());
        }
        ...
        //public double GetTotalPrice(Func<double,double> test2)
        //{
        //    return GetValueOfProducts() - GetBonus(test2);
        //}
    }
}
